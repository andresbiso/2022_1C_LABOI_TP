...
public class MedicoFieldsPanel extends FieldsBasePanel {
	...
	private JTextField costoConsultaTxt;

	public MedicoFieldsPanel(PanelManager panelManager) {
		super(panelManager);
		inicializarPanel();
	}
	...
	public void inicializarPanel() {
		...
		JPanel costoConsultaFieldPanel = new JPanel();
		costoConsultaFieldPanel.setLayout(new BoxLayout(costoConsultaFieldPanel, BoxLayout.X_AXIS));
		JLabel costoConsultaLbl = new JLabel("Costo Consulta:");
		costoConsultaTxt = new JTextField("");
		costoConsultaFieldPanel.add(costoConsultaLbl);
		costoConsultaFieldPanel.add(costoConsultaTxt);
		this.add(costoConsultaFieldPanel);
